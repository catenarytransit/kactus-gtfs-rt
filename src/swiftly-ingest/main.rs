...
struct SwiftlyVehicleInfo {
    ...
    previous_vehicle_sch_adh_secs: Option<f32>,
    previous_vehicle_sch_adh_str: Option<String>,
    block: String,
    block_assignment_info: String,
    is_predictable: bool,
    trip: String,
    ...
    distance_along_stop_path: f32,
    stop_path_index: i32,
    gtfs_stop_sequence: i32,
    occupancy_count: Option<i32>,
